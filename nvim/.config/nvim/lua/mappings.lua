...
end, { desc = "dap Begin or resume debugging test" })
map("n", "<leader>dl", function()
  require("dap").run_last()
  require("dap").repl.open()
end, { desc = "dap Debug last test" })
map("n", "<leader>dh", function()
  require("dap.ui.widgets").hover()
end, { desc = "dap Show dap hover widget" })
map("n", "<leader>dp", function()
  require("dap.ui.widgets").preview()
end, { desc = "dap Show dap preview widget" })
map("n", "<leader>df", function()
  local widgets = require "dap.ui.widgets"
  widgets.centered_float(widgets.frames)
end, { desc = "dap Show debug frames" })
map("n", "<leader>dv", function()
  local widgets = require "dap.ui.widgets"
  widgets.centered_float(widgets.scopes)
end, { desc = "dap Show debug scopes" })
...
map(
  ...
  { desc = "trouble Toggle trouble diagnostics (current buffer)" }
)
